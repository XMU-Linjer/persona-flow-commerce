...
public enum ErrorCode {
    ...
    TRADE_STOCK_RESERVATION_FAILED("TRADE_STOCK_RESERVATION_FAILED", HttpStatus.CONFLICT, "Stock reservation failed"),
    TRADE_STOCK_SERVICE_UNAVAILABLE("TRADE_STOCK_SERVICE_UNAVAILABLE", HttpStatus.SERVICE_UNAVAILABLE, "Stock service is unavailable"),
